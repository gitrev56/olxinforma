...
export const Route = createFileRoute("/anuncio/iphone-13-pro-256gb")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "iPhone 13 Pro 256gb - R$ 1.700" },
      { property: "og:description", content: "iPhone 13 Pro 256GB azul, usado em bom estado. Frete grátis, até 10x sem juros." },
      { property: "og:image", content: iphoneHero },
    ],
  }),
